"""Test restructure script on all PDFs."""
...
if __name__ == "__main__":
    ...
    # Find all energy_supported_section.pdf files
    template_dir = Path("template1")
    pdf_files = list(template_dir.glob("*/energy_supported_section.pdf"))
    
    if not pdf_files:
        print("No energy_supported_section.pdf files found in template1/")
        ...
        for pdf_name in pdf_names:
            pdf_path = template_dir / pdf_name / "energy_supported_section.pdf"
            if pdf_path.exists():
