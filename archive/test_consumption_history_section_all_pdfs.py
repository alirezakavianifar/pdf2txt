...
from restructure_consumption_history_section import restructure_consumption_history_section_json
...
def process_pdf(pdf_path: Path, output_dir: Path):
    ...
    try:
        ...
        if extracted_json.exists():
            restructure_consumption_history_section_json(extracted_json, restructured_json)
            return True
        else:
