"""Verify extraction for 4_600_9001713204128 against expected values from image."""
import json
...
def verify():
    output_file = Path("output/4_600_9001713204128_energy_supported_section_restructured.json")
    
    with open("output/verification_9001713204128.txt", "w", encoding="utf-8") as f:
        log("=" * 60, f)
        log("VERIFICATION: 4_600_9001713204128", f)
        log("=" * 60, f)
        ...
        log("\n" + "=" * 60, f)
        log("Verification complete. See output/verification_9001713204128.txt for details.", f)
